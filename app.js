...
async function handleLogin(e) { 
            ...
            try {
                ...
                if(d.status === "success") { 
                    ...
                    // --- NOUVEAU : SAUVEGARDE DE LA SESSION ---
                ...
                if (error.name === 'AbortError') { Swal.fire('Délai dépassé', 'Serveur lent. Vérifiez votre connexion.', 'warning'); } 
                else { Swal.fire('Erreur Système', 'Impossible de contacter le serveur.', 'error'); }
            } finally {
